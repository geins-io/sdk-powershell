...
function Initialize-Envelope {
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => Envelope' | Write-Debug
...
Convert from JSON to Envelope<PSCustomObject>
...
Envelope<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelope {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => Envelope' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in Envelope
