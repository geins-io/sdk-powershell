...
EnvelopePageAreaModelsReadPageAreaFamily<PSCustomObject>
#>

function Initialize-EnvelopePageAreaModelsReadPageAreaFamily {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopePageAreaModelsReadPageAreaFamily' | Write-Debug
...
Convert from JSON to EnvelopePageAreaModelsReadPageAreaFamily<PSCustomObject>
...
EnvelopePageAreaModelsReadPageAreaFamily<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopePageAreaModelsReadPageAreaFamily {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopePageAreaModelsReadPageAreaFamily' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopePageAreaModelsReadPageAreaFamily
