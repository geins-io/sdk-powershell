...
.PARAMETER HasExternalAuth
Set this to true if the management platform will not be the main way of authentication.
.OUTPUTS

UserModelsWriteUserProfile<PSCustomObject>
#>

function Initialize-UserModelsWriteUserProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => UserModelsWriteUserProfile' | Write-Debug
...
Convert from JSON to UserModelsWriteUserProfile<PSCustomObject>
...
UserModelsWriteUserProfile<PSCustomObject>
#>
function ConvertFrom-JsonToUserModelsWriteUserProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => UserModelsWriteUserProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in UserModelsWriteUserProfile
        $AllProperties = ("UserId", "SiteId", "Email", "Password", "FirstName", "LastName", "PhoneNr", "MobilePhoneNr", "Company", "UserTypeId", "Address", "Address2", "Address3", "DoorCode", "PersonalId", "Birthyear", "Zip", "City", "CareOf", "Country", "CountryId", "Gender", "Newsletter", "HasExternalAuth")
        ...
        if (!([bool]($JsonParameters.PSobject.Properties.name -match "HasExternalAuth"))) { #optional property not found
            $HasExternalAuth = $null
        } else {
            $HasExternalAuth = $JsonParameters.PSobject.Properties["HasExternalAuth"].value
        }
