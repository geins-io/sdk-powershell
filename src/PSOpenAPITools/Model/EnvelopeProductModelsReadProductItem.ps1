...
EnvelopeProductModelsReadProductItem<PSCustomObject>
#>

function Initialize-EnvelopeProductModelsReadProductItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeProductModelsReadProductItem' | Write-Debug
...
Convert from JSON to EnvelopeProductModelsReadProductItem<PSCustomObject>
...
EnvelopeProductModelsReadProductItem<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeProductModelsReadProductItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeProductModelsReadProductItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeProductModelsReadProductItem
