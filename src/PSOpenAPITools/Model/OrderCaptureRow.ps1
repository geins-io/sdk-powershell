...
OrderCaptureRow<PSCustomObject>
#>

function Initialize-OrderCaptureRow {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderCaptureRow' | Write-Debug
...
Convert from JSON to OrderCaptureRow<PSCustomObject>
...
OrderCaptureRow<PSCustomObject>
#>
function ConvertFrom-JsonToOrderCaptureRow {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderCaptureRow' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderCaptureRow
