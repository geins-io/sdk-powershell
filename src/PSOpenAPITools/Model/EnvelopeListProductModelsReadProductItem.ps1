...
EnvelopeListProductModelsReadProductItem<PSCustomObject>
#>

function Initialize-EnvelopeListProductModelsReadProductItem {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeListProductModelsReadProductItem' | Write-Debug
...
Convert from JSON to EnvelopeListProductModelsReadProductItem<PSCustomObject>
...
EnvelopeListProductModelsReadProductItem<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeListProductModelsReadProductItem {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeListProductModelsReadProductItem' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeListProductModelsReadProductItem
