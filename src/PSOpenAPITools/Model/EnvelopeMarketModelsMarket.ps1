...
EnvelopeMarketModelsMarket<PSCustomObject>
#>

function Initialize-EnvelopeMarketModelsMarket {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeMarketModelsMarket' | Write-Debug
...
Convert from JSON to EnvelopeMarketModelsMarket<PSCustomObject>
...
EnvelopeMarketModelsMarket<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeMarketModelsMarket {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeMarketModelsMarket' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeMarketModelsMarket
