...
EnvelopeUserModelsReadUserProfile<PSCustomObject>
#>

function Initialize-EnvelopeUserModelsReadUserProfile {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeUserModelsReadUserProfile' | Write-Debug
...
Convert from JSON to EnvelopeUserModelsReadUserProfile<PSCustomObject>
...
EnvelopeUserModelsReadUserProfile<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeUserModelsReadUserProfile {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeUserModelsReadUserProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeUserModelsReadUserProfile
