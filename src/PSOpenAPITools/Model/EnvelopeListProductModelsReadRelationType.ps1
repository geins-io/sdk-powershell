...
EnvelopeListProductModelsReadRelationType<PSCustomObject>
#>

function Initialize-EnvelopeListProductModelsReadRelationType {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeListProductModelsReadRelationType' | Write-Debug
...
Convert from JSON to EnvelopeListProductModelsReadRelationType<PSCustomObject>
...
EnvelopeListProductModelsReadRelationType<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeListProductModelsReadRelationType {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeListProductModelsReadRelationType' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeListProductModelsReadRelationType
