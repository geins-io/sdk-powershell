...
EnvelopeCategoryModelsReadCategory<PSCustomObject>
#>

function Initialize-EnvelopeCategoryModelsReadCategory {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeCategoryModelsReadCategory' | Write-Debug
...
Convert from JSON to EnvelopeCategoryModelsReadCategory<PSCustomObject>
...
EnvelopeCategoryModelsReadCategory<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeCategoryModelsReadCategory {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeCategoryModelsReadCategory' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeCategoryModelsReadCategory
