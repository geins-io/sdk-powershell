...
EnvelopeInt<PSCustomObject>
#>

function Initialize-EnvelopeInt {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeInt' | Write-Debug
...
Convert from JSON to EnvelopeInt<PSCustomObject>
...
EnvelopeInt<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeInt {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeInt' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeInt
