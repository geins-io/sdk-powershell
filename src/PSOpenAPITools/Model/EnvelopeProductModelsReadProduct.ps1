...
EnvelopeProductModelsReadProduct<PSCustomObject>
#>

function Initialize-EnvelopeProductModelsReadProduct {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeProductModelsReadProduct' | Write-Debug
...
Convert from JSON to EnvelopeProductModelsReadProduct<PSCustomObject>
...
EnvelopeProductModelsReadProduct<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeProductModelsReadProduct {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeProductModelsReadProduct' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeProductModelsReadProduct
