...
EnvelopeVariantModelsReadVariantGroup<PSCustomObject>
#>

function Initialize-EnvelopeVariantModelsReadVariantGroup {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeVariantModelsReadVariantGroup' | Write-Debug
...
Convert from JSON to EnvelopeVariantModelsReadVariantGroup<PSCustomObject>
...
EnvelopeVariantModelsReadVariantGroup<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeVariantModelsReadVariantGroup {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeVariantModelsReadVariantGroup' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeVariantModelsReadVariantGroup
