...
BrandModelsReadBrand<PSCustomObject>
#>

function Initialize-BrandModelsReadBrand {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => BrandModelsReadBrand' | Write-Debug
...
Convert from JSON to BrandModelsReadBrand<PSCustomObject>
...
BrandModelsReadBrand<PSCustomObject>
#>
function ConvertFrom-JsonToBrandModelsReadBrand {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => BrandModelsReadBrand' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in BrandModelsReadBrand
        $AllProperties = ("BrandId", "Name", "ExternalId", "Descriptions")
