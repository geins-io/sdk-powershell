...
EnvelopeString<PSCustomObject>
#>

function Initialize-EnvelopeString {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeString' | Write-Debug
...
Convert from JSON to EnvelopeString<PSCustomObject>
...
EnvelopeString<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeString {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeString' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeString
