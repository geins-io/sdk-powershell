...
OrderModelsOrderUpdate<PSCustomObject>
#>

function Initialize-OrderModelsOrderUpdate {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => OrderModelsOrderUpdate' | Write-Debug
...
Convert from JSON to OrderModelsOrderUpdate<PSCustomObject>
...
OrderModelsOrderUpdate<PSCustomObject>
#>
function ConvertFrom-JsonToOrderModelsOrderUpdate {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => OrderModelsOrderUpdate' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in OrderModelsOrderUpdate
        $AllProperties = ("ExternalId", "ParcelNumber", "ExternalOrderStatus")
