...
PriceListModelsWritePriceListPrice<PSCustomObject>
#>

function Initialize-PriceListModelsWritePriceListPrice {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PriceListModelsWritePriceListPrice' | Write-Debug
...
Convert from JSON to PriceListModelsWritePriceListPrice<PSCustomObject>
...
PriceListModelsWritePriceListPrice<PSCustomObject>
#>
function ConvertFrom-JsonToPriceListModelsWritePriceListPrice {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PriceListModelsWritePriceListPrice' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PriceListModelsWritePriceListPrice
        $AllProperties = ("PriceListId", "Price", "ProductId", "Currency", "StaggeredCount")
