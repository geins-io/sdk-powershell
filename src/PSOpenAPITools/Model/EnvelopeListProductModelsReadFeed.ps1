...
EnvelopeListProductModelsReadFeed<PSCustomObject>
#>

function Initialize-EnvelopeListProductModelsReadFeed {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeListProductModelsReadFeed' | Write-Debug
...
Convert from JSON to EnvelopeListProductModelsReadFeed<PSCustomObject>
...
EnvelopeListProductModelsReadFeed<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeListProductModelsReadFeed {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeListProductModelsReadFeed' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeListProductModelsReadFeed
