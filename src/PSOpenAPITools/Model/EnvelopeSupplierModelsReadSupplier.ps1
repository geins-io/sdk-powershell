...
EnvelopeSupplierModelsReadSupplier<PSCustomObject>
#>

function Initialize-EnvelopeSupplierModelsReadSupplier {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeSupplierModelsReadSupplier' | Write-Debug
...
Convert from JSON to EnvelopeSupplierModelsReadSupplier<PSCustomObject>
...
EnvelopeSupplierModelsReadSupplier<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeSupplierModelsReadSupplier {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeSupplierModelsReadSupplier' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeSupplierModelsReadSupplier
