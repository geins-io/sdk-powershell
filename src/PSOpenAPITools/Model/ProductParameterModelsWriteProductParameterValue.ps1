...
ProductParameterModelsWriteProductParameterValue<PSCustomObject>
#>

function Initialize-ProductParameterModelsWriteProductParameterValue {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => ProductParameterModelsWriteProductParameterValue' | Write-Debug
...
Convert from JSON to ProductParameterModelsWriteProductParameterValue<PSCustomObject>
...
ProductParameterModelsWriteProductParameterValue<PSCustomObject>
#>
function ConvertFrom-JsonToProductParameterModelsWriteProductParameterValue {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => ProductParameterModelsWriteProductParameterValue' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in ProductParameterModelsWriteProductParameterValue
        $AllProperties = ("ProductId", "ParameterId", "Value", "LocalizedDescriptions")
