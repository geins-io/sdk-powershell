...
PaymentModelsPaymentOptionQuery<PSCustomObject>
#>

function Initialize-PaymentModelsPaymentOptionQuery {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => PaymentModelsPaymentOptionQuery' | Write-Debug
...
Convert from JSON to PaymentModelsPaymentOptionQuery<PSCustomObject>
...
PaymentModelsPaymentOptionQuery<PSCustomObject>
#>
function ConvertFrom-JsonToPaymentModelsPaymentOptionQuery {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => PaymentModelsPaymentOptionQuery' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in PaymentModelsPaymentOptionQuery
        $AllProperties = ("SiteId", "Email", "CustomerTypeId", "CountryId", "Sum")
