...
EnvelopeVariantModelsReadVariant<PSCustomObject>
#>

function Initialize-EnvelopeVariantModelsReadVariant {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Creating PSCustomObject: PSOpenAPITools => EnvelopeVariantModelsReadVariant' | Write-Debug
...
Convert from JSON to EnvelopeVariantModelsReadVariant<PSCustomObject>
...
EnvelopeVariantModelsReadVariant<PSCustomObject>
#>
function ConvertFrom-JsonToEnvelopeVariantModelsReadVariant {
    Param(
        [AllowEmptyString()]
        [string]$Json
    )
    ...
    Process {
        'Converting JSON to PSCustomObject: PSOpenAPITools => EnvelopeVariantModelsReadVariant' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug

        $JsonParameters = ConvertFrom-Json -InputObject $Json

        # check if Json contains properties not defined in EnvelopeVariantModelsReadVariant
