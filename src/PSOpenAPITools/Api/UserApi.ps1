...
function New-UserProfile {
    ...
    Process {
        'Calling method: New-UserProfile' | Write-Debug
        ...
        $LocalVarUri = '/API/User'

        if (!$UserProfile) {
            throw "Error! The required parameter `UserProfile` missing when calling create_user_profile."
        }

        $LocalVarBodyParameter = $UserProfile | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "EnvelopeUserModelsReadUserProfile" `
...
#>
function Invoke-DeleteUserProfile {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [String]
    ...
    Process {
        'Calling method: Invoke-DeleteUserProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/API/User/email'

        if (!$Email) {
            throw "Error! The required parameter `Email` missing when calling delete_user_profile."
        }
...
function Get-UserProfile {
    ...
    Process {
        'Calling method: Get-UserProfile' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/API/User/Query'

        if (!$Query) {
            throw "Error! The required parameter `Query` missing when calling get_user_profile."
        }
...
function Update-UserProfile {
    ...
    Process {
        ...
        if (!$UserProfile) {
            throw "Error! The required parameter `UserProfile` missing when calling update_user_profile."
        }
