...
#>
function Invoke-ListPriceLists {
    [CmdletBinding()]
    Param (
        [String]
    ...
    Process {
        'Calling method: Invoke-ListPriceLists' | Write-Debug
        ...
        $LocalVarUri = '/API/PriceList/List'
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'GET' `
                                ...
                                -ReturnType "PriceListModelsPriceList[]" `
...
.PARAMETER PriceListPrices
List of new price list prices.

.PARAMETER ProductIdType
The type of product id supplied in {priceListPrices}

.PARAMETER PricesIncVat
Set to true if prices in {priceListPrices} includes VAT. Leave blank or set to false if they exclude VAT.
...
#>
function Update-PricelistPrices {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Update-PricelistPrices' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/API/PriceList/Price'
        ...
        if ($PricesIncVat) {
            $LocalVarQueryParameters['pricesIncVat'] = $PricesIncVat
        }

        if (!$PriceListPrices) {
            throw "Error! The required parameter `PriceListPrices` missing when calling update_pricelist_prices."
        }

        $LocalVarBodyParameter = $PriceListPrices | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'PUT' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "PriceListModelsPriceListPriceResponse" `
                                -IsBodyNullable $false
