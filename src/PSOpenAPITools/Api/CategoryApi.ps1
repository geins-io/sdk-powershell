...
function New-Category {
    ...
    Process {
        ...
        $LocalVarUri = '/API/Category'

        if (!$Category) {
            throw "Error! The required parameter `Category` missing when calling create_category."
        }

        $LocalVarBodyParameter = $Category | ConvertTo-Json -Depth 100
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "EnvelopeCategoryModelsReadCategory" `
...
function Get-CategoryById {
    ...
    Process {
        ...
        $LocalVarUri = '/API/Category/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling get_category_by_id."
        }
...
#>
function Invoke-QueryCategories {
    [CmdletBinding()]
    Param (
        [Parameter(Position = 0, ValueFromPipeline = $true, ValueFromPipelineByPropertyName = $true, Mandatory = $false)]
        [PSCustomObject]
    ...
    Process {
        'Calling method: Invoke-QueryCategories' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/API/Category/Query'

        if (!$Query) {
            throw "Error! The required parameter `Query` missing when calling query_categories."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -FormParameters $LocalVarFormParameters `
                                -CookieParameters $LocalVarCookieParameters `
                                -ReturnType "CategoryModelsReadCategory[]" `
                                -IsBodyNullable $false
...
function Update-Category {
    ...
    Process {
        'Calling method: Update-Category' | Write-Debug
        $PSBoundParameters | Out-DebugParameter | Write-Debug
        ...
        $LocalVarUri = '/API/Category/{id}'
        if (!$Id) {
            throw "Error! The required parameter `Id` missing when calling update_category."
        }
        $LocalVarUri = $LocalVarUri.replace('{id}', [System.Web.HTTPUtility]::UrlEncode($Id))

        if (!$Category) {
            throw "Error! The required parameter `Category` missing when calling update_category."
        }
