...
#>
function Invoke-QueryPaymentOptions {
    [CmdletBinding()]
    Param (
    ...
    Process {
        'Calling method: Invoke-QueryPaymentOptions' | Write-Debug
        ...
        $LocalVarUri = '/API/Payment/Query'

        if (!$Query) {
            throw "Error! The required parameter `Query` missing when calling query_payment_options."
        }
        ...
        $LocalVarResult = Invoke-ApiClient -Method 'POST' `
                                ...
                                -ReturnType "PaymentModelsPaymentOption[]" `
